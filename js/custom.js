(function (factory) {
    ...
    modal.querySelector(".modal__container-js");
    ...
    const girlUpdate = num => {
      ...
      girlBg.style = 'object-fit: none;'; // girlBg.src = 'img/content/spin.gif';
    ...
    const selectUpdate = () => {
      ...
      if (girlBg.includes('img/content/spin.gif')) return;
    ...
    const btnPush = e => {
      ...
      if (id === 'kiss') {
        btn.classList.add('hvr-ripple-out-push');
      } else {
    ...
    buttonSlap.addEventListener("click", e => checkLastGirl() ? btnPush(e) : openModal());
    ...
    modalContainerGirls.addEventListener("click", e => {
      ...
      if (button) {
        ...
        document.querySelector(".modal__scroll").scrollIntoView({
          behavior: "smooth",
          block: "start"
        });
      }
    ...
    resultBtn.addEventListener("click", () => {
      modalContainerBtn.style.opacity = 0;
      modal.querySelector(".loading").style.display = 'flex';
      setTimeout(function () {
